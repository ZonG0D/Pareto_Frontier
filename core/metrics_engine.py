...
class ParetoMetric:
    timestamp: float
    prompt_snippet: str
    semantic_accuracy: float  # 0.0 to 1.0 (assumed via LLM-based evaluation or baseline comparison)
...
class MetricsEngine:
    ...
    def log_execution(self, prompt: str, accuracy: float, cost: float, latency: float, cache_hit: bool) -> ParetoMetric:
